...
String sqlO="select o.productId, p.subCategory, o.productName, count(o.productName) cnt, p.file"
		+" from orders as o inner join product as p on o.productId=p.id group by o.productName"
		+" order by cnt desc limit 3";
ResultSet rsO=st.executeQuery(sqlO);
while(rsO.next()){
	int productId=rsO.getInt("productId");
...
String sql3="select * from product order by id desc limit 3";
