        ...
        <div class="bg-main">
            <div class="mid-header wrap">
                ...
                <ul class="user-menu">
                    ...
                    <li>
                    	<a href="../logout.jsp" style="font-size:16px; padding-top:10px">로그아웃<i class='bx bx-log-out-circle'></i></a>
                    </li> 
                </ul>
            </div>
        </div>      
        <div class="bg-second">
            <div class="bottom-header container">
                <ul class="main-menu">
                    ...
                    <li><a href="addCategory.jsp">카테고리 등록</a></li>
                    <li><a href="categoryList.jsp">카테고리 목록</a></li>
                </ul>
            </div>            
        </div>
    </div>
